    ...
    <div className='py-5 px-5 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={(e) => {
          ...
          <h3 className='text-lg font-medium mb-2'>what's our Capatain's email</h3>
          <input
            required
            value={email}
            onChange={(e) => {
      ...
      <div>
        <p className='text-[10px] leading-tight'>This site is proteced by reCAPTCHA and the <span className='underline'>Google Privacy Policy</span>and <span className='underline'>Term of Service apply</span>.</p>
      </div>
    </div>
  )
}
